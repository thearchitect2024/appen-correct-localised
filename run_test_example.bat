@echo off
REM Example batch file to run AppenCorrect performance tests
REM Make sure your .env file is configured with OPENAI_MODEL and appropriate API key

echo Running AppenCorrect Performance Tests
echo ======================================

echo.
echo Test 1: 5 English sentences with OpenAI model
